...
const apiURL = "https://api.openweathermap.org/data/2.5/weather?lat=42.0381059&lon=-111.4005351&units=imperial&APPID=5fbe37b45777a8e16856c8c4c241f6e7";
fetch(apiURL)
...
//Forecast Code
const forecastURL = 'https://api.openweathermap.org/data/2.5/forecast?lat=42.0381059&lon=-111.4005351&units=imperial&APPID=5fbe37b45777a8e16856c8c4c241f6e7';
fetch(forecastURL)
    .then((response) => response.json())
    .then((jsonObject) => {
